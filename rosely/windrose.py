...
class WindRose(object):
    ...
    def calc_stats(self, normed=False, bins=[0,4,8,12,16,20,50], variable_names=None):
        """
        ...
        labels = ['0 - 4 m/s', '4 - 8 m/s', '8 - 12 m/s', '12 - 16 m/s', '16 - 20 m/s', '>20 m/s']
    ...
    def plot(self, output_type='save', out_file=None,
        ...
        if output_type == 'save':
            ...
            img_bytes3 = fig.to_image(format = "svg", width=900, height=900, scale = 1)
            return img_bytes3
